...
myStartupHook = do
      ...
      spawnOnce "picom -bcf -i 0.8 -e 0.8 --no-fading-openclose &" --start compositing
      spawnOnce "emacs --daemon" -- emacs
      spawnOnce "dunst &" -- dunst
      spawnOnce "~/.fehbg" -- background
      spawnOnce "tint2 -c /home/sh/.config/tint2/tint2rc"
...
myScratchpads = [ NS "terminal" spawnTerm findTerm manageTerm
    ...
    spawnEmacsScratch = "emacsclient -a='' -nc --frame-parameters='(quote (font . \"JetBrainsMono:size=24:weight=regular:antialias=true:hinting=true:hintstyle=hintfull\")(name . \"emacs-scratch\"))'"
